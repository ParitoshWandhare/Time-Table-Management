...
import { Clock, MapPin, User, Book, AlertCircle } from "lucide-react"
...
export default function FacultyTimetable() {
  ...
  const { data: timetable, isLoading: timetableLoading } = useQuery({
    queryKey: ['faculty-timetable', selectedFaculty],
    queryFn: async () => {
  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex flex-col space-y-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Faculty Timetable</h1>
          <p className="text-muted-foreground">View teaching schedule for faculty members</p>
        </div>
      ...
      {selectedFaculty && timetableLoading && (
        <Card>
      ...
      {selectedFaculty && !timetableLoading && timetable && timetable.length === 0 && (
        <Alert>
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>
            No classes scheduled for this faculty member yet.
          </AlertDescription>
        </Alert>
      )}
                                        ...
                                        <div className="space-y-2">
                                          ...
                                          <div className="space-y-1 text-xs text-muted-foreground">
                                            ...
                                            <div className="flex items-center gap-1">
                                              ...
                                              <span className="truncate">{entry.classrooms?.name}</span>
                                            </div>
                                            <div className="flex items-center gap-1">
